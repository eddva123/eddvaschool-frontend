...
function pageTitle(pathname) {
  if (pathname === '/student' || pathname === '/student/dashboard') return 'Dashboard';
  return pathname
    .split('/')
    .pop()
    .split('-')
    ...
    <header className="sticky top-0 z-30 border-b border-slate-100 bg-white/80 backdrop-blur-xl px-6 py-3 dark:border-slate-800 dark:bg-slate-950/80">
      <div className="flex items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to="/student/profile" className="flex items-center gap-3 border-l border-slate-100 pl-4 dark:border-slate-800">
