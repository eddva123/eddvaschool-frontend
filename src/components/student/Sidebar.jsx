...
const studentGroups = [
  {
    ...
    items: [
      ...
      { to: '/student/planner', label: 'Study Planner', icon: Target },
    ],
  },
  {
    ...
    items: [
      ...
      { to: '/student/battle-arena', label: 'Battle Arena', icon: Trophy },
  ...
  },
  {
    ...
    items: [
      { to: '/student/ai-assistant', label: 'AI Doubt Solver', icon: Sparkles },
      { to: '/student/feedback', label: 'Feedback', icon: MessageSquareWarning },
      { to: '/student/chat', label: 'Chat', icon: MessageSquare },
      { to: '/student/profile', label: 'Profile', icon: SettingsIcon },
    ],
  },
];
