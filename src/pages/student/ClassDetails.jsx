...
export default function ClassDetails() {
  ...
  if (!course) {
    return (
      <div className="flex h-[60vh] flex-col items-center justify-center text-center">
        ...
        <Link to="/student/classes" className="mt-4 text-sm font-bold text-blue-600 hover:underline">Back to Classes</Link>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      {/* Header */}
      <div>
        <Link to="/student/classes" className="mb-4 inline-flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-blue-600 transition-colors">
          <ChevronLeft size={16} />
          Back to Classes
        </Link>
