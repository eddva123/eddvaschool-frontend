        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <section>
            <div className="mb-4 flex items-center justify-between">
              ...
              <Link to="/student/classes" className="text-sm font-bold text-blue-600 hover:text-blue-700 dark:text-blue-400">View All</Link>
            </div>
            ...
            {continueLearning ? (
              ...
              <div className="flex flex-col items-center justify-center rounded-[2rem] border border-slate-100 border-dashed bg-slate-50 p-12 text-center dark:border-slate-800 dark:bg-slate-900/50">
                ...
                <Link to="/student/classes" className="mt-6 rounded-xl bg-blue-600 px-6 py-3 text-sm font-bold text-white transition hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-600/20">
                  Browse Classes
                </Link>
              </div>
            )}
          ...
          <div className="rounded-[2rem] border border-slate-100 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            {todayPlan && todayPlan.length > 0 ? (
              ...
              <div className="text-center py-6">
                ...
                <Link to="/student/planner" className="mt-4 inline-block text-xs font-bold text-blue-600 hover:text-blue-700">Go to Planner →</Link>
              </div>
            )}
          </div>
